...
def main_worker(gpu, ngpus_per_node, args):
    ...
    process_model(model, args, replace_first_layer=args.hp.first_layer, replace_map={
    ...
    os.system("cp setup.sh "+log_dir)
    os.system("cp -r ./models "+log_dir)
    os.system("cp -r ./utils "+log_dir)
