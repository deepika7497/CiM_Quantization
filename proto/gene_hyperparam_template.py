...
#import sys
#sys.path.insert(0, '/home/nano01/a/saxenau/ADCLess/EfficientPyTorch/proto')
...
def gene_base_template():
    ...
    hyper.nbits_alpha = hyper.nbits_alpha
    
    hyper.wbitslice = hyper.wbitslice
    hyper.abitslice = hyper.abitslice
    hyper.xbar = hyper.xbar
